...
bool CApplication::InternOnCreateTextures()
{
	...
	// -----------------------------------------------------------------------------
	CreateDepthTarget(&m_pDepthTarget);		// monochrome float 32
	CreateColorTarget(&m_pNormalTarget);	// rgba 8
...
{
	CreateVertexShader("..\\data\\shader\\ssao.fx", "VSGBufferShader", &m_pGBufferVertexShader);
	CreatePixelShader("..\\data\\shader\\ssao.fx", "PSGBufferShader", &m_pGBufferPixelShader);
	CreateVertexShader("..\\data\\shader\\ssao.fx", "VSShader", &m_pVertexShader);
	CreatePixelShader("..\\data\\shader\\ssao.fx", "PSShader", &m_pPixelShader);
	CreateVertexShader("..\\data\\shader\\ssao.fx", "VSPostShader", &m_pPostVertexShader);
	CreatePixelShader("..\\data\\shader\\ssao.fx", "PSPostShader", &m_pPostPixelShader);
